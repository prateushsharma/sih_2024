...
def predict_route():
 ...
 'Tomato Target Spot' 'Tomato Tomato mosaic virus' 'Tomato healthy'
 'Waterlogging in plant' 'algal leaf in tea' 'anthracnose in tea'
 'bird eye spot in tea' 'brown blight in tea' 'cabbage looper' 'corn crop'
 'ginger' 'healthy tea leaf' 'lemon canker' 'onion'
